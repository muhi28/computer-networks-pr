...
{
    // This part is used to produce the source and dest. addresses
    ...
    // Create the message and set the source and destination fields.
...
{
    // used to increment the hop count
