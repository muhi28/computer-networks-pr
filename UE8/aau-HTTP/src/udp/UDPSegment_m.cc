...
void UDPSegment::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->source_port);
    doParsimPacking(b,this->destination_port);
}

void UDPSegment::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cPacket::parsimUnpack(b);
    doParsimUnpacking(b,this->source_port);
    doParsimUnpacking(b,this->destination_port);
}

const char * UDPSegment::getSource_port() const
{
    return this->source_port.c_str();
}

void UDPSegment::setSource_port(const char * source_port)
{
    this->source_port = source_port;
}

const char * UDPSegment::getDestination_port() const
{
    return this->destination_port.c_str();
}

void UDPSegment::setDestination_port(const char * destination_port)
{
...
int UDPSegmentDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "source_port")==0) return base+0;
    if (fieldName[0]=='d' && strcmp(fieldName, "destination_port")==0) return base+1;
...
std::string UDPSegmentDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    UDPSegment *pp = (UDPSegment *)object; (void)pp;
    switch (field) {
        case 0: return oppstring2string(pp->getSource_port());
        case 1: return oppstring2string(pp->getDestination_port());
        default: return "";
    }
}
...
bool UDPSegmentDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    UDPSegment *pp = (UDPSegment *)object; (void)pp;
    switch (field) {
        case 0: pp->setSource_port((value)); return true;
        case 1: pp->setDestination_port((value)); return true;
