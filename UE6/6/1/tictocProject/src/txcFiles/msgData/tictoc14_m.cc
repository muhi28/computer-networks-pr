...
TicTocMsg14::TicTocMsg14(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->source = 0;
    this->destination = 0;
    this->hopCount = 0;
...
TicTocMsg14::TicTocMsg14(const TicTocMsg14& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
TicTocMsg14Descriptor::TicTocMsg14Descriptor() : omnetpp::cClassDescriptor("TicTocMsg14", "omnetpp::cPacket")
{
